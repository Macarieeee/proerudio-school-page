  ...
  const advantages = [
    {
      ...
      description: "Echipa noastră este formată din profesori cu certificări internaționale și ani de experiență în predare. Fiecare lecție este pregătită cu atenție pentru a asigura progres rapid.",
    },
    {
      icon: Trophy,
      title: "Rezultate excepționale",
      description: "Peste 95% din elevii noștri promovează examenele Cambridge la prima încercare. Succesul lor este dovada calității programelor noastre educaționale.",
    },
    {
      icon: Heart,
      title: "Mediu modern și prietenos",
      description: "Săli de clasă dotate cu tehnologie modernă, materiale interactive și o atmosferă caldă care încurajează învățarea și exprimarea liberă în limba engleză.",
    },
  ];
